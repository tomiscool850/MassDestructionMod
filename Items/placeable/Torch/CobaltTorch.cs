...
{
	public class CobaltTorch : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Torch with Cobalt flames.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.LightScorces.Torchs.CobaltTorchTile>();
			item.flame = true;
			item.value = 5000;
		}
