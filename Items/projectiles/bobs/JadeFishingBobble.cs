...
using MassDestruction.Items.tools.fishingRods;
...
namespace MassDestruction.Items.projectiles.bobs
{
	public class JadeFishingBobble : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Jade bobble");
		}
		...
		public override bool PreDrawExtras(SpriteBatch spriteBatch)
		{
			...
			if (type == ModContent.ItemType<JadeFishingRod>())
			{
