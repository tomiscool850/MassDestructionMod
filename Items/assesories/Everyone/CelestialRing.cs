...
namespace MassDestruction.Items.assesories.Everyone
{
	...
	public abstract class CelestialRing : ModItem
	{
	...
	public class GreenExclusiveAccessory : CelestialRing
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Celestial Ring");
			Tooltip.SetDefault("increased all damage by 100%");
		}

		public override void UpdateAccessory(Player player, bool hideVisual)
		{

			player.meleeDamage += 1.00f;
			player.rangedDamage += 1.00f;
			player.magicDamage += 1.00f;
			player.minionDamage += 1.00f;
