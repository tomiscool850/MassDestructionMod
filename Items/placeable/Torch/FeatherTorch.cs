...
{
	public class FeatherTorch : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Torch with Feather flames.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.LightScorces.Torchs.FeatherTorchTile>();
			item.flame = true;
			item.value = 5000;
		}
