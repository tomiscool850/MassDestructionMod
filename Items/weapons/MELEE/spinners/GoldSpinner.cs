...
{
    public class GoldSpinner : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.damage = 17;
            item.knockBack = 3f;
            item.rare = item.rare = ItemRarityID.Yellow;
            ...
            item.shoot = ModContent.ProjectileType<GoldSpinnerProjectile>();
            item.shootSpeed = 9f;
        }
    ...
    public class GoldSpinnerProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
