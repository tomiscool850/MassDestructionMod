...
{
    public class JadeSpinner : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.damage = 33;
            item.knockBack = 3f;
            item.rare = item.rare = ItemRarityID.Green;
            ...
            item.shoot = ModContent.ProjectileType<JadeSpinnerProjectile>();
            item.shootSpeed = 9f;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<JadeBar>(), 18);
    ...
    public class JadeSpinnerProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
