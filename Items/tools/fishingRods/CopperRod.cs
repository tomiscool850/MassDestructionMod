...
{
	public class CopperRod : ModItem
	{


		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Copper Fishing Rod");
			Tooltip.SetDefault("Copper.");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<CopperBobber>();
		...
		{
			int bobberAmount = Main.rand.Next(1, 1); //3 to 5 bobbers
