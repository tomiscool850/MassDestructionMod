...
{
	public class SteelBeamBlockTile : ModTile
	{
		public override void SetDefaults()
		{
			TileID.Sets.Ore[Type] = false;
			Main.tileSpelunker[Type] = false; // The tile will be affected by spelunker highlighting
			Main.tileValue[Type] = 10000; // Metal Detector value, see https://terraria.gamepedia.com/Metal_Detector
			...
			name.SetDefault("Steel Beam Tile");
			AddMapEntry(new Color(152, 171, 198), name);

			drop = ModContent.ItemType<Items.placeable.Block.SteelBeamBlock>();
