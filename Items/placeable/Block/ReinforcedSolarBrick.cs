...
{
	public class ReinforcedSolarBrick : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Reinforced Solar brick yee.");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.blocks.ReinforcedSolarBrickTile>();
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<ReinforcedSolarFragment>());
