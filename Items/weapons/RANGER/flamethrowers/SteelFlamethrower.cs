...
namespace MassDestruction.Items.weapons.RANGER.flamethrowers
{
	...
	public class SteelFlamethrower : ModItem
	{
		...
		{
			item.damage = 26; // The item's damage.
			item.ranged = true;
			item.width = 50;
			item.height = 18;
			item.useTime = 4;
			...
			item.value = 10000;
			item.rare = ItemRarityID.White; // Sets the item's rarity.
			item.UseSound = SoundID.Item34;
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<SteelFlames>();
