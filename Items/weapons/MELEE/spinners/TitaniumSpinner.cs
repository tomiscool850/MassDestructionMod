...
{
    public class TitaniumSpinner : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.damage = 25;
            item.knockBack = 2f;
            item.rare = item.rare = ItemRarityID.White;
            ...
            item.shoot = ModContent.ProjectileType<TitaniumSpinnerProjectile>();
            item.shootSpeed = 8f;
        }
    ...
    public class TitaniumSpinnerProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
