...
{
	public class CobaltFlailProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "MassDestruction/Items/projectiles/Chains/FlailChains/CobaltFlailProejctileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Flail Ball"); // Set the projectile name to Example Flail Ball
		}
