...
{
	public class CobaltDresserTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Cobalt Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Cobalt Dresser";
			dresserDrop = ModContent.ItemType<Items.placeable.dresser.CobaltDresser>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ModContent.ItemType<Items.placeable.dresser.CobaltDresser>();
