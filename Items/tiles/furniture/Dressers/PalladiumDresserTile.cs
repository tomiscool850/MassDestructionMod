...
namespace MassDestruction.Items.tiles.furniture.Dressers
{
	public class PalladiumDresserTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Palladium Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Cobalt Dresser";
			dresserDrop = ModContent.ItemType<Items.placeable.dresser.PalladiumDresser>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ModContent.ItemType<Items.placeable.dresser.PalladiumDresser>();
