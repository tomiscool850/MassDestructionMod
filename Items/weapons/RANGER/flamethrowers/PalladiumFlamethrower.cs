...
namespace MassDestruction.Items.weapons.RANGER.flamethrowers
{
	...
	public class PalladiumFlamethrower : ModItem
	{

		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Palladium of flames.");
		}

		public override void SetDefaults()
		{
			item.damage = 19; // The item's damage.
			item.ranged = true;
			item.width = 50;
			item.height = 18;
			...
			item.knockBack = 4; // A high knockback. Vanilla Flamethrower uses 0.3f for a weak knockback.
			item.value = 10000;
			item.rare = ItemRarityID.Orange; // Sets the item's rarity.
			item.UseSound = SoundID.Item34;
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<PalladiumFlames>();
