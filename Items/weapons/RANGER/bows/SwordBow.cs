...
{
	public class SwordBow : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("bow but sword...?? also iron exclusive.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.knockBack = 3.8f; // Sets the item's knockback. Note that projectiles shot by this weapon will use its and the used ammunition's knockback added together.
