...
namespace MassDestruction.Items.assesories.Mage
{

	public abstract class MagesSecondStaff : ModItem
	{
	...
	public class green : MagesSecondStaff
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Mages Second staff");
			Tooltip.SetDefault("increases magic damage ");
		}
