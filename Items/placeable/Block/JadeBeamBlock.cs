...
{
	public class JadeBeamBlock : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("jade but as a beam.");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.blocks.JadeBeamBlockTile>();
		}

		public override void AddRecipes()
		{
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(ModContent.ItemType<JadeBar>(), 2);
