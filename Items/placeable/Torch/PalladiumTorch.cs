...
{
	public class PalladiumTorch : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Torch with Palladium flames.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.LightScorces.Torchs.PalladiumTorchTile>();
			item.flame = true;
			item.value = 5000;
		}
