...
namespace MassDestruction.Items.weapons.RANGER.flamethrowers
{
	...
	public class TitaniumFlamethrower : ModItem
	{

		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Titanium of flames.");
		}

		public override void SetDefaults()
		{
			item.damage = 23; // The item's damage.
			item.ranged = true;
			item.width = 50;
			item.height = 18;
			...
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<TitaniumFlames>();
