...
{
	public abstract class ZombieRing : ModItem
	{
	...
	public class cute : GoblinCape
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Zombie Ring");
			Tooltip.SetDefault("makes you immune to all Zombie except modded ones");
		}
		...
		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			...
			player.npcTypeNoAggro[NPCID.SwampZombie] = true;
