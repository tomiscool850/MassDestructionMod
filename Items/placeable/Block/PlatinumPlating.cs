...
{
	public class PlatinumPlating : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("all plating of Platinum.");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.blocks.PlatinumPlatingBlockTile>();
		}
