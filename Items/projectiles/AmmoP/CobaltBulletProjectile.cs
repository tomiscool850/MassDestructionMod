...
{
	public class CobaltBulletProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Bullet projectile");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.MoonlordBullet;           //Act exactly like default Bullet
		}
