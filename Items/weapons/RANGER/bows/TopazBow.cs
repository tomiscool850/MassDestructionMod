...
namespace MassDestruction.Items.weapons.RANGER.bows
{
	public class TopazBow : ModItem
	{
		...
		{
			Tooltip.SetDefault("i like gems want more gem weapons?.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = 9; //idk why but all the guns in the vanilla source have this
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.Topaz, 11);
