...
{
	public class JadeMaceProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "MassDestruction/Items/projectiles/Chains/FlailChains/JadeMaceProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Jade Macey ball" +
				""); 
		}
