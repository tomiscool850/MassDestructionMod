...
namespace MassDestruction.Items.tiles.furniture.Clocks
{
	public class PalladiumClockTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<Items.placeable.clock.PalladiumClock>());
		}
	}
}