...
{
	public class JadeDresserTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Jade Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Jade Dresser";
			dresserDrop = ModContent.ItemType<Items.placeable.dresser.JadeDresser>();
		}
