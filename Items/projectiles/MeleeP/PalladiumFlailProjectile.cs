...
{
	public class PalladiumFlailProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "MassDestruction/Items/projectiles/Chains/FlailChains/PalladiumFlailProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Palladium Flail Ball"); // Set the projectile name to Example Flail Ball
		}
