...
namespace MassDestruction.Items.projectiles.MageP
{
	...
	public class SteelStaffProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.myPlayer == projectile.owner && projectile.ai[0] == 0f)
			{
				...
				if (player.channel)
				{
					float maxDistance = 9f; // This also sets the maximun speed the projectile can reach while following the cursor.
