...
namespace MassDestruction.Items.assesories.Ranger
{

	public abstract class KetminPills : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Plastic>(), 8);
	...
	public class wow : WarriorsKeychain
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ketmin Pills");
			Tooltip.SetDefault("increases ranged damage by 5%, speed by 10%.");
		}
