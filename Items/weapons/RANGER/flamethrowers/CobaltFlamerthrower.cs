...
namespace MassDestruction.Items.weapons.RANGER.flamethrowers
{
	...
	public class CobaltFlamethrower : ModItem
	{

		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Cobalt of flames.");
		}

		public override void SetDefaults()
		{
			item.damage = 18; // The item's damage.
			item.ranged = true;
			item.width = 50;
			item.height = 18;
			...
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<CobaltFlames>();
