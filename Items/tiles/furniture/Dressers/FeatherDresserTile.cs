...
{
	public class FeatherDresserTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Feather Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Feather Dresser";
			dresserDrop = ModContent.ItemType<Items.placeable.dresser.FeatherDresser>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ModContent.ItemType<Items.placeable.dresser.JadeDresser>();
