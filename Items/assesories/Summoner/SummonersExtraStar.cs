...
namespace MassDestruction.Items.assesories.Summoner
{
	...
	public abstract class SummonersExtraStar : ModItem
	{
	...
	public class Yellow : SummonersExtraStar
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Summoners extra star");
			Tooltip.SetDefault("increased summoner damage by 25%");
		}
