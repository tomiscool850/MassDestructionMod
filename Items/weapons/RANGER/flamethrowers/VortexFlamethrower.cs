...
namespace MassDestruction.Items.weapons.RANGER.flamethrowers
{
	...
	public class VortexFlamethrower : ModItem
	{

		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Vortex of flames.");
		}

		public override void SetDefaults()
		{
			item.damage = 79; // The item's damage.
			item.ranged = true;
			item.width = 50;
			item.height = 18;
			...
			item.value = 10000;
			item.rare = ItemRarityID.LightRed; // Sets the item's rarity.
			item.UseSound = SoundID.Item34;
			item.autoReuse = true;
			item.shoot = ModContent.ProjectileType<VortexFlames>();
			item.shootSpeed = 15f; // How fast the flames will travel. Vanilla Flamethrower uses 7f and consequentially has less reach. item.shootSpeed and projectile.timeLeft together control the range.
