...
{
	public class TitaniumPlating : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("all plating of Titanium.");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.blocks.TitaniumPlatingBlockTile>();
		}
