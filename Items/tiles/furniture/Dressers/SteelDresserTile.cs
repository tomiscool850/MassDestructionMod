...
{
	public class SteelDresserTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Steel Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Steel Dresser";
			dresserDrop = ModContent.ItemType<Items.placeable.dresser.SteelDresser>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ModContent.ItemType<Items.placeable.dresser.SteelDresser>();
