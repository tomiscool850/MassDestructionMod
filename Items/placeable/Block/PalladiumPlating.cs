...
{
	public class PalladiumPlating : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("all plating of Palladium.");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<tiles.blocks.PalladiumPlatingBlockTile>();
		}
