...
{
    public class AdamantiteSpinner : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<AdamantiteSpinnerProjectile>();
            item.shootSpeed = 7f;
        }
    ...
    public class AdamantiteSpinnerProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
