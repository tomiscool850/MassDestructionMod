...
{
	public class ReinforcedSolarBrickTile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Reinforced solar Brick Tile");
			AddMapEntry(new Color(152, 171, 198), name);

			drop = ModContent.ItemType<Items.placeable.Block.ReinforcedSolarBrick>();
