...
namespace MassDestruction.Items.ammo.Darts
{
	public class CopperDart : ModItem
	{
		...
		{
			Tooltip.SetDefault("copper spike.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<projectiles.AmmoP.CopperDartProjectile>();   //The projectile shoot when your weapon using this ammo
