...
namespace MassDestruction.Items.projectiles.MageP
{
	...
	public class JadeLazar : ModProjectile
	{
		...
		private const float MOVE_DISTANCE = 80f;
		...
		{
			{
				DrawLaser(spriteBatch, Main.projectileTexture[projectile.type], Main.player[projectile.owner].Center,
					projectile.velocity, 10, projectile.damage, -1.57f, 1f, 1000f, Color.Green, (int)MOVE_DISTANCE);
			}
			return false;
		}
