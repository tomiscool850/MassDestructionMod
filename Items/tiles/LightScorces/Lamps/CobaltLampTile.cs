...
namespace MassDestruction.Items.tiles.LightScorces.Lamps
{
	...
	internal class CobaltLampTile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<Items.placeable.Lamp.CobaltLamp>());
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			var flameTexture = mod.GetTexture("Items/tiles/LightScorces/Lamps/CobaltLampTile_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
